...
class ShootsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoot" do
    assert_difference('Shoot.count') do
       post shoots_url, params: { shoot: { slug: @shoot.slug, assignment_description: @shoot.assignment_description, start: @shoot.start, end: @shoot.end, location: @shoot.location, contact_name: @shoot.contact_name, contact_phone_number: @shoot.contact_phone_number, deadline: @shoot.deadline } }
    end
